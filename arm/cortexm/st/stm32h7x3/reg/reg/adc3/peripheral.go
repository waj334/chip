...
var (
	Adc1 = (*_adc3)(unsafe.Pointer(uintptr(0x40022000)))
	Adc2 = (*_adc3)(unsafe.Pointer(uintptr(0x40022100)))
	Adc3 = (*_adc3)(unsafe.Pointer(uintptr(0x58026000)))
)
...
const (
	...
	RegisterCrFieldBoostMask  = 0x100
)

// GetBoost Boost mode control
func (r *registerCrType) GetBoost() bool {
	return (volatile.LoadUint32((*uint32)(r)) & RegisterCrFieldBoostMask) != 0
}

// SetBoost Boost mode control
func (r *registerCrType) SetBoost(value bool) {
	if value {
		volatile.StoreUint32((*uint32)(r), volatile.LoadUint32((*uint32)(r))|RegisterCrFieldBoostMask)
	} else {
		volatile.StoreUint32((*uint32)(r), volatile.LoadUint32((*uint32)(r))&^RegisterCrFieldBoostMask)
	}
}
