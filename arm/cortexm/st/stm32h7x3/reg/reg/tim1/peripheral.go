...
// registerCrr6Type capture/compare register 6
type registerCrr6Type uint32

const (
	RegisterCrr6FieldCcr6Shift = 0
	RegisterCrr6FieldCcr6Mask  = 0xffff
)

// GetCcr6 Capture/Compare 6 value
func (r *registerCrr6Type) GetCcr6() uint16 {
	return uint16((volatile.LoadUint32((*uint32)(r)) & RegisterCrr6FieldCcr6Mask) >> RegisterCrr6FieldCcr6Shift)
}

// SetCcr6 Capture/Compare 6 value
func (r *registerCrr6Type) SetCcr6(value uint16) {
	volatile.StoreUint32((*uint32)(r), (volatile.LoadUint32((*uint32)(r))&^RegisterCrr6FieldCcr6Mask)|(uint32(value)<<RegisterCrr6FieldCcr6Shift))
}
