...
var (
	Adc3_common  = (*_adc3_common)(unsafe.Pointer(uintptr(0x58026300)))
	Adc12_common = (*_adc3_common)(unsafe.Pointer(uintptr(0x40022300)))
)

type _adc3_common struct {
	Csr  registerCsrType
	_    [4]byte
	Ccr  registerCcrType
	Cdr  registerCdrType
...
const (
	RegisterCcrFieldTsenShift = 23
	RegisterCcrFieldTsenMask  = 0x800000
)

// GetTsen Temperature sensor enable
func (r *registerCcrType) GetTsen() bool {
	return (volatile.LoadUint32((*uint32)(r)) & RegisterCcrFieldTsenMask) != 0
}

// SetTsen Temperature sensor enable
func (r *registerCcrType) SetTsen(value bool) {
	if value {
		volatile.StoreUint32((*uint32)(r), volatile.LoadUint32((*uint32)(r))|RegisterCcrFieldTsenMask)
	} else {
		volatile.StoreUint32((*uint32)(r), volatile.LoadUint32((*uint32)(r))&^RegisterCcrFieldTsenMask)
	}
}
