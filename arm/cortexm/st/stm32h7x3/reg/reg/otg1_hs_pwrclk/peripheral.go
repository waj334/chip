...
var (
	Otg1_hs_pwrclk = (*_otg1_hs_pwrclk)(unsafe.Pointer(uintptr(0x40040e00)))
	Otg2_hs_pwrclk = (*_otg1_hs_pwrclk)(unsafe.Pointer(uintptr(0x40080e00)))
)

type _otg1_hs_pwrclk struct {
