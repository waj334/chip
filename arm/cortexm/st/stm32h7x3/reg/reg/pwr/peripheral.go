...
const (
	RegisterCr3FieldScuenShift = 2
	RegisterCr3FieldScuenMask  = 0x4
)

// GetScuen SD converter Enable
func (r *registerCr3Type) GetScuen() bool {
	return (volatile.LoadUint32((*uint32)(r)) & RegisterCr3FieldScuenMask) != 0
}

// SetScuen SD converter Enable
func (r *registerCr3Type) SetScuen(value bool) {
	if value {
		volatile.StoreUint32((*uint32)(r), volatile.LoadUint32((*uint32)(r))|RegisterCr3FieldScuenMask)
	} else {
		volatile.StoreUint32((*uint32)(r), volatile.LoadUint32((*uint32)(r))&^RegisterCr3FieldScuenMask)
	}
}
...
// GetUsb33den VDD33USB voltage level detector enable.
func (r *registerCr3Type) GetUsb33den() bool {
	return (volatile.LoadUint32((*uint32)(r)) & RegisterCr3FieldUsb33denMask) != 0
}
