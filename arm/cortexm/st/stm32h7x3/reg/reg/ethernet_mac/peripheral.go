...
const (
	RegisterMacrwkpfrFieldMacrwkpfrShift = 0
	RegisterMacrwkpfrFieldMacrwkpfrMask  = 0xffffffff
)

// GetMacrwkpfr MACRWKPFR
func (r *registerMacrwkpfrType) GetMacrwkpfr() uint32 {
	return uint32((volatile.LoadUint32((*uint32)(r)) & RegisterMacrwkpfrFieldMacrwkpfrMask) >> RegisterMacrwkpfrFieldMacrwkpfrShift)
}

// SetMacrwkpfr MACRWKPFR
func (r *registerMacrwkpfrType) SetMacrwkpfr(value uint32) {
	volatile.StoreUint32((*uint32)(r), (volatile.LoadUint32((*uint32)(r))&^RegisterMacrwkpfrFieldMacrwkpfrMask)|(uint32(value)<<RegisterMacrwkpfrFieldMacrwkpfrShift))
}
...
const (
	RegisterMachwf1rFieldAddr64Shift = 14
	RegisterMachwf1rFieldAddr64Mask  = 0xc000
)

// GetAddr64 ADDR64
func (r *registerMachwf1rType) GetAddr64() uint8 {
	return uint8((volatile.LoadUint32((*uint32)(r)) & RegisterMachwf1rFieldAddr64Mask) >> RegisterMachwf1rFieldAddr64Shift)
}

// SetAddr64 ADDR64
func (r *registerMachwf1rType) SetAddr64(value uint8) {
	volatile.StoreUint32((*uint32)(r), (volatile.LoadUint32((*uint32)(r))&^RegisterMachwf1rFieldAddr64Mask)|(uint32(value)<<RegisterMachwf1rFieldAddr64Shift))
}
