...
var (
	Sdmmc1 = (*_sdmmc1)(unsafe.Pointer(uintptr(0x52007000)))
	Sdmmc2 = (*_sdmmc1)(unsafe.Pointer(uintptr(0x48022400)))
)
...
// registerVerType SDMMC IP version register
type registerVerType uint32

const (
	RegisterVerFieldMinrevShift = 0
	RegisterVerFieldMinrevMask  = 0xf
)

// GetMinrev IP minor revision number.
func (r *registerVerType) GetMinrev() uint8 {
	return uint8((volatile.LoadUint32((*uint32)(r)) & RegisterVerFieldMinrevMask) >> RegisterVerFieldMinrevShift)
}

// SetMinrev IP minor revision number.
func (r *registerVerType) SetMinrev(value uint8) {
	volatile.StoreUint32((*uint32)(r), (volatile.LoadUint32((*uint32)(r))&^RegisterVerFieldMinrevMask)|(uint32(value)<<RegisterVerFieldMinrevShift))
}

const (
	RegisterVerFieldMajrevShift = 4
	RegisterVerFieldMajrevMask  = 0xf0
)

// GetMajrev IP major revision number.
func (r *registerVerType) GetMajrev() uint8 {
	return uint8((volatile.LoadUint32((*uint32)(r)) & RegisterVerFieldMajrevMask) >> RegisterVerFieldMajrevShift)
}

// SetMajrev IP major revision number.
func (r *registerVerType) SetMajrev(value uint8) {
	volatile.StoreUint32((*uint32)(r), (volatile.LoadUint32((*uint32)(r))&^RegisterVerFieldMajrevMask)|(uint32(value)<<RegisterVerFieldMajrevShift))
}

// registerIdType SDMMC IP identification register
type registerIdType uint32

const (
	RegisterIdFieldIp_idShift = 0
	RegisterIdFieldIp_idMask  = 0xffffffff
)

// GetIp_id SDMMC IP identification.
func (r *registerIdType) GetIp_id() uint32 {
	return uint32((volatile.LoadUint32((*uint32)(r)) & RegisterIdFieldIp_idMask) >> RegisterIdFieldIp_idShift)
}

// SetIp_id SDMMC IP identification.
func (r *registerIdType) SetIp_id(value uint32) {
	volatile.StoreUint32((*uint32)(r), (volatile.LoadUint32((*uint32)(r))&^RegisterIdFieldIp_idMask)|(uint32(value)<<RegisterIdFieldIp_idShift))
}
