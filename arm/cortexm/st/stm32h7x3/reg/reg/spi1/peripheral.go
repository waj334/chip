...
var (
	Spi1 = (*_spi1)(unsafe.Pointer(uintptr(0x40013000)))
	Spi2 = (*_spi1)(unsafe.Pointer(uintptr(0x40003800)))
	Spi3 = (*_spi1)(unsafe.Pointer(uintptr(0x40003c00)))
	Spi4 = (*_spi1)(unsafe.Pointer(uintptr(0x40013400)))
	Spi5 = (*_spi1)(unsafe.Pointer(uintptr(0x40015000)))
	Spi6 = (*_spi1)(unsafe.Pointer(uintptr(0x58001400)))
)
