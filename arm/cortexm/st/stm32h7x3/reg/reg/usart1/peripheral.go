...
var (
	Uart4  = (*_usart1)(unsafe.Pointer(uintptr(0x40004c00)))
	Uart5  = (*_usart1)(unsafe.Pointer(uintptr(0x40005000)))
	Uart7  = (*_usart1)(unsafe.Pointer(uintptr(0x40007800)))
	Uart8  = (*_usart1)(unsafe.Pointer(uintptr(0x40007c00)))
	Usart1 = (*_usart1)(unsafe.Pointer(uintptr(0x40011000)))
	Usart2 = (*_usart1)(unsafe.Pointer(uintptr(0x40004400)))
	Usart3 = (*_usart1)(unsafe.Pointer(uintptr(0x40004800)))
	Usart6 = (*_usart1)(unsafe.Pointer(uintptr(0x40011400)))
)
